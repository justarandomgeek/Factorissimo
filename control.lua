               ...
               for _,outEntity in pairs(entities) do
                 if outEntity.valid then
                   ...
                   elseif outEntity.name == "small-lamp" then
                      ...
                      if inEntity then
                        inEntity.operable = false
                        outEntity.operable = false
                        local lampcontrol = outEntity.get_or_create_control_behavior()
                        lampcontrol.circuit_condition = {
                          condition={
                            first_signal = {type="virtual", name="signal-anything"},
                            comparator=">"
                            }
                          }
                        lampcontrol.connect_to_logistic_network=false
                        lampcontrol.use_colors=true
                   ...
                   elseif outEntity.name == "relay-combinator" then
                      ...
                      if inEntity then
                        inEntity.operable = false
                        outEntity.operable = false
                        local lampcontrol = inEntity.get_or_create_control_behavior()
                        lampcontrol.circuit_condition = {
                          condition={
                            first_signal = {type="virtual", name="signal-anything"},
                            comparator=">"
